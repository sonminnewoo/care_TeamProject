...
class MatchingInfoAdapter2 : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            TYPE_PAST -> {
                val pastLayout = inflater.inflate(R.layout.past_matching_row2, parent, false)
                PastMatchingViewHolder(pastLayout)
            }
            TYPE_PROGRESS -> {
                val progressLayout = inflater.inflate(R.layout.progress_matching_row2, parent, false)
